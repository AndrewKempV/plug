...
const ArrowBackLeft = (props: {
  ...
  return (
    ...
    >
      <Image style={{ tintColor: props.tintColor }} source={Images.back} />
    </TouchableOpacity>
  );
};
        ...
        >
          ...
          >
            ...
            leftComponent === "goBack" ? (
              <ArrowBackLeft
                tintColor={this.props.arrowBackColor}
                style={this.props.arrowBackStyle}
                goBackPressed={this.props.goBackPressed}
              />
            ) : (
              leftComponent
            )}
