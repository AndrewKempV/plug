...
class InstagramCropper extends React.Component<PickerProps> {
  ...
  public pinch: RefObject<PinchGestureHandler> = React.createRef();
  public pan: RefObject<PanGestureHandler> = React.createRef();
  public tap: RefObject<TapGestureHandler> = React.createRef();
  ...
  constructor(props: PickerProps) {
    ...
    this.transX = InstagramCropper.withBouncyLimits(
      InstagramCropper.withDecaying(
        InstagramCropper.withAddingFocalDisplacement(
          InstagramCropper.withPreservingAdditiveOffset(
            this.dragX,
            this.panState,
            this.scale
          ),
    ...
    this.transY = InstagramCropper.withBouncyLimits(
      InstagramCropper.withDecaying(
        InstagramCropper.withAddingFocalDisplacement(
          InstagramCropper.withPreservingAdditiveOffset(
            this.dragY,
...
> {
  ...
  public render() {
    return <InstagramCropper {...this.props} key={this.state.val} />;
  }
}
