...
import { CarouselProps } from "./SnapCarousel";

const IS_ANDROID = Platform.OS === "android";

// Get scroll interpolator's input range from an array of slide indexs
// Indexs are relative to the current active slide (index 0)
