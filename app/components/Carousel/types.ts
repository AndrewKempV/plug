...
export interface CarouselGestureState extends PanResponderGestureState {
  stateID: number;
  moveX: number;
  moveY: number;
  x0: number;
...
export interface CarouselRenderProps<T> {
  /**
...
export interface CarouselProps<T> {
  ...
  onGestureStart?: (s: CarouselGestureState) => void;
}

export interface GestureEvent extends GestureResponderEvent {}
